...
5. 영향 파일: `Assets/@Project/City` generator/tests/generated meshes/prefabs/material/README, `Assets/@Project/Scenes/GameScene.unity`, `Assets/@Project/Game/Editor/{GameSceneSetup.cs,GameSceneValidator.cs,CameraRootLifecycleTests.cs}`, `Assets/@Project/Game/Scripts/{CameraRoot.cs,GameSceneController.cs,GameplayRoot.cs}`, `Docs/CrowdCity/INTERFACES.md`
