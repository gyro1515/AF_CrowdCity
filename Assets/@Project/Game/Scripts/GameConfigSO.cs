...
public sealed class GameConfigSO : ScriptableObject
{
    ...
    [SerializeField] private SimTuning sim = new SimTuning { RecruitRadius = 1.2f, CombatRadius = 0.5f, LeaderAloneRadius = 0.7f, ConvertPerSecond = 100f, PairNormalizer = 15, RateLimitConversion = true, LeaderProtection = true, SeparationVisitBudget = 0, CombatFlatConvertRate = true, UseDynamicConvertRate = false, ConvertPerSecondPerMember = 0.1f };
    ...
    private void OnValidate()
    {
        ...
        sim.ConvertPerSecondPerMember = Mathf.Max(0f, sim.ConvertPerSecondPerMember);
