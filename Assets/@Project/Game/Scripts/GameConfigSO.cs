...
public sealed class GameConfigSO : ScriptableObject
{
    ...
    [SerializeField] private SimTuning sim = new SimTuning { RecruitRadius = 1.2f, CombatRadius = 0.5f, LeaderAloneRadius = 0.7f, ConvertPerSecond = 40f, PairNormalizer = 15, RateLimitConversion = true, LeaderProtection = true, DensityFieldGain = 0.5f };
    ...
    private void OnValidate()
    {
        ...
        sim.DensityFieldGain = Mathf.Max(0f, sim.DensityFieldGain);
